...
pub extern fn ts_parser_set_included_ranges(self: ?*Parser, ranges: [*c]const Range, length: u32) bool;
pub extern fn ts_parser_included_ranges(self: ?*const Parser, length: [*c]u32) [*c]const Range;
pub extern fn ts_parser_parse(self: ?*Parser, old_tree: ?*const Tree, input: Input) ?*Tree;
pub extern fn ts_parser_parse_string(self: ?*Parser, old_tree: ?*const Tree, string: [*c]const u8, length: u32) ?*Tree;
pub extern fn ts_parser_parse_string_encoding(self: ?*Parser, old_tree: ?*const Tree, string: [*c]const u8, length: u32, encoding: InputEncoding) ?*Tree;
...
pub extern fn ts_parser_set_cancellation_flag(self: ?*Parser, flag: [*c]const usize) void;
pub extern fn ts_parser_cancellation_flag(self: ?*const Parser) [*c]const usize;
